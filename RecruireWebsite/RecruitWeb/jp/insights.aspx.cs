...
{
    public partial class jp_insights : System.Web.UI.Page
    {
        ...
        {
            string sql = "select top 1 titleText,contentText,thumbnailText from Insights where languageText='日文' and areaText='金融服务' order by submitDateTime desc";
            ...
            sql = "select top 1 titleText,contentText,thumbnailText from Insights where languageText='日文' and areaText='生命科学' order by submitDateTime desc";
            ...
            sql = "select top 1 titleText,contentText,thumbnailText from Insights where languageText='日文' and areaText='制造工业' order by submitDateTime desc";
            ds = DBUtil.executeQuery(sql);
            if (ds.Tables[0].Rows.Count > 0)
            {
            ...
            sql = "select top 1 titleText,contentText,thumbnailText from Insights where languageText='日文' and areaText='酒店地产' order by submitDateTime desc";
            ds = DBUtil.executeQuery(sql);
            if (ds.Tables[0].Rows.Count > 0)
            {
            ...
            sql = "select top 1 titleText,contentText,thumbnailText from Insights where languageText='日文' and areaText='能源及化工' order by submitDateTime desc";
            ds = DBUtil.executeQuery(sql);
            if (ds.Tables[0].Rows.Count > 0)
            {
            ...
            sql = "select top 1 titleText,contentText,thumbnailText from Insights where languageText='日文' and areaText='汽车及配件' order by submitDateTime desc";
            ds = DBUtil.executeQuery(sql);
            if (ds.Tables[0].Rows.Count > 0)
            {
