<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main-insights-edit.aspx.cs" Inherits="RecruitWeb.admin.main_insights_edit" %>
...
<tr style="color:Red;text-align:center"><td colspan="2"><span id="errorText">所有项目都是必填项，请检查您的输入</span></td></tr>
    <tr><td colspan="2" style="text-align:center">编辑行业视角文章</td></tr>
