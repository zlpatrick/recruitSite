...
{
    public partial class jp_job_center : System.Web.UI.Page
    {
        ...
        private void loadPositions()
        {
            ...
            string sql = "select * from Positions where languageText='日文'order by submitDateTime desc";
            if (!companyType.Equals(""))
            {
                sql = "select * from Positions where companyType='" + companyType + "'  and languageText='日文' order by submitDateTime desc";
            }
            ...
            if (Request.QueryString["search"] != null)
            {
                ...
                sql = "select * from Positions where titleText like '%" + searchKey + "%'  and languageText='日文' order by submitDateTime desc";
            }
