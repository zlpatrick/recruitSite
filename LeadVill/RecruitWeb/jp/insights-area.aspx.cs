...
{
    public partial class jp_insights_area : System.Web.UI.Page
    {
        public DataSet ds; 
        ...
        private void loadInsightsList()
        {
            ...
            string sql = "select * from Insights where areaText='" + areaText + "' and languageText='日文' order by submitDateTime desc";
